...
//[Serializable]
//public class SaveData//STUDY : ISerializationCallbackReceiver
//{

//    //シングルトンを実装するための実体、初アクセス時にLoadする。
//    private static SaveDataSTUDY _instance = null;
//    public static SaveDataSTUDY Instance
...
//    {
//        _instance = JsonUtility.FromJson<SaveDataSTUDY>(GetJson());
//    }
...
//        else
//        {
//            _jsonText = JsonUtility.ToJson(new SaveDataSTUDY());
//        }
